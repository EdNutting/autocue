...
class TestDebugLogEnableDisable:
    ...
    def test_clear_logs_no_op_when_disabled(self) -> None:
    ...
    def test_log_server_word_writes_when_enabled(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            try:
                ...
                assert debug_log.SERVER_LOG.exists()
                content: str = debug_log.SERVER_LOG.read_text()
