...
class TestAlternativePunctuationMatching:
    ...
    def test_slash_matches_slash(self) -> None:
        """'/' should match when spoken as 'slash'."""
        tracker: ScriptTracker = ScriptTracker("Press A / B to continue")
        # Advance to A
    ...
    def test_slash_matches_or(self) -> None:
    ...
    def test_slash_matches_forward_slash(self) -> None:
    ...
    def test_ampersand_matches_ampersand(self) -> None:
    ...
    def test_plus_matches_plus(self) -> None:
        """'+' should match when spoken as 'plus'."""
        tracker: ScriptTracker = ScriptTracker("Calculate 5 + 3")
    ...
    def test_at_matches_at(self) -> None:
        """'@' should match when spoken as 'at'."""
        tracker: ScriptTracker = ScriptTracker("Email me @ example dot com")
    ...
    def test_percent_matches_percent(self) -> None:
        """'%' should match when spoken as 'percent'."""
        tracker: ScriptTracker = ScriptTracker("The rate is 50 % annually")
    ...
    def test_equals_matches_equals(self) -> None:
        """'=' should match when spoken as 'equals'."""
        tracker: ScriptTracker = ScriptTracker("So 2 + 2 = 4")
    ...
    def test_equals_matches_is(self) -> None:
    ...
    def test_tilde_matches_approximately(self) -> None:
        """'~' should match when spoken as 'approximately'."""
        tracker: ScriptTracker = ScriptTracker("The value is ~ 100")
    ...
    def test_tilde_matches_about(self) -> None:
    ...
    def test_pipe_matches_or(self) -> None:
        """'|' should match when spoken as 'or'."""
        tracker: ScriptTracker = ScriptTracker("Use true | false")
    ...
    def test_pipe_matches_pipe(self) -> None:
...
class TestAlternativeNumberMatching:
    ...
    def test_hundred_matches_one_hundred(self) -> None:
        """'100' should match when spoken as 'one hundred'."""
        tracker: ScriptTracker = ScriptTracker("The value is 100 dollars")
        tracker.update("the value is")
        pos_before: int = tracker.optimistic_position
    ...
    def test_hundred_matches_a_hundred(self) -> None:
    ...
    def test_thousand_matches_one_thousand(self) -> None:
        """'1000' should match when spoken as 'one thousand'."""
        tracker: ScriptTracker = ScriptTracker("There are 1000 items")
    ...
    def test_thousand_matches_a_thousand(self) -> None:
    ...
    def test_eleven_hundred(self) -> None:
        ...
        tracker: ScriptTracker = ScriptTracker("The count is 1100 total")
    ...
    def test_decimal_point_form(self) -> None:
        """'3.14' should match when spoken as 'three point one four'."""
        tracker: ScriptTracker = ScriptTracker("Pi is 3.14 approximately")
    ...
    def test_decimal_oh_form(self) -> None:
        """'3.07' should match when spoken as 'three point oh seven'."""
        tracker: ScriptTracker = ScriptTracker("The value is 3.07 units")
        tracker.update("the value is")
        pos_before: int = tracker.optimistic_position
    ...
    def test_decimal_point_only(self) -> None:
        """'0.3' should match when spoken as 'point three'."""
        tracker: ScriptTracker = ScriptTracker("The ratio is 0.3 today")
    ...
    def test_half_fraction(self) -> None:
        ...
        tracker: ScriptTracker = ScriptTracker("Take 0.5 of the total")
        tracker.update("take")
        pos_before: int = tracker.optimistic_position
    ...
    def test_ordinal_first(self) -> None:
        ...
        tracker: ScriptTracker = ScriptTracker("This is the 1st test")
    ...
    def test_ordinal_second(self) -> None:
        ...
        tracker: ScriptTracker = ScriptTracker("This is the 2nd item")
        tracker.update("this is the")
        pos_before: int = tracker.optimistic_position
    ...
    def test_ordinal_twenty_third(self) -> None:
        """'23rd' should match when spoken as 'twenty third'."""
        tracker: ScriptTracker = ScriptTracker("It is the 23rd day")
    ...
    def test_mixed_4k(self) -> None:
        """'4K' should match when spoken as 'four k'."""
        tracker: ScriptTracker = ScriptTracker("The display is 4K resolution")
    ...
    def test_mixed_4k_thousand(self) -> None:
    ...
    def test_mixed_100gb(self) -> None:
        """'100GB' should match when spoken as 'one hundred gigabytes'."""
        tracker: ScriptTracker = ScriptTracker("Storage is 100GB available")
    ...
    def test_mixed_m3(self) -> None:
        """'M3' should match when spoken as 'm three'."""
        tracker: ScriptTracker = ScriptTracker("The M3 processor is fast")
        tracker.update("the")
        pos_before: int = tracker.optimistic_position
    ...
    def test_mixed_5m_metres(self) -> None:
        """'5m' should match when spoken as 'five metres'."""
        tracker: ScriptTracker = ScriptTracker("The distance is 5m away")
    ...
    def test_comma_separated_number(self) -> None:
        ...
        tracker: ScriptTracker = ScriptTracker("We have 1,000 users")
    ...
    def test_eleven_thousand_comma(self) -> None:
        ...
        tracker: ScriptTracker = ScriptTracker("There are 11,000 participants")
        tracker.update("there are")
        pos_before: int = tracker.optimistic_position
    ...
    def test_number_in_context(self) -> None:
        """Numbers should work correctly in full sentences."""
        tracker: ScriptTracker = ScriptTracker(
            "The M3 processor has 25 billion transistors")

        # Advance through the sentence
        tracker.update(
            "the m three processor has twenty five billion transistors")
...
class TestExpansionValidationBug:
    ...
    def test_long_expansion_no_false_backtrack(self) -> None:
        ...
        tracker: ScriptTracker = ScriptTracker(
            "some text and 1500 large items")
    ...
    def test_expansion_does_not_trigger_validation(self) -> None:
        ...
        """
        tracker: ScriptTracker = ScriptTracker(
            "prefix 1500 suffix words here today")
    ...
    def test_six_word_expansion_no_backtrack(self) -> None:
        ...
        """
        tracker: ScriptTracker = ScriptTracker(
            "there are 1500000 items remaining")

        tracker.update("there are")
        initial_pos: int = tracker.optimistic_position

        # Build up the expansion word by word
        words: list[str] = ["one", "million", "five", "hundred", "thousand"]
        transcript: str = "there are"
...
class TestExpansionStateClearingOnPositionChange:
    ...
    def test_expansion_state_cleared_on_jump_to(self) -> None:
        """jump_to() should clear any in-progress expansion state."""
        tracker: ScriptTracker = ScriptTracker(
            "number 1000000 text here other words")
    ...
    def test_expansion_state_cleared_on_backtrack(self) -> None:
        ...
        tracker: ScriptTracker = ScriptTracker(
            "start text here 1000000 some different words after")
        ...
        assert tracker.active_expansions, "Should be in expansion matching"
        expansion_was_active: bool = len(tracker.active_expansions) > 0
    ...
    def test_words_match_correctly_after_expansion_cleared(self) -> None:
        ...
        tracker: ScriptTracker = ScriptTracker(
            "apple 100 banana cherry grape melon")
    ...
    def test_cascading_backtrack_prevented(self) -> None:
        ...
        script: str = "the number is 1000000 as written also decimal numbers are interesting"
        ...
        result: ScriptPosition = tracker.update("as written")
